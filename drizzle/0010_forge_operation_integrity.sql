-- Durable, retry-safe common-to-rare forge operations.
...
CREATE INDEX IF NOT EXISTS forge_operations_user_created_idx
  ON app.forge_operations (user_id, created_at DESC, id DESC);
CREATE INDEX IF NOT EXISTS forge_operations_player_created_idx
  ON app.forge_operations (player_id, created_at DESC, id DESC);
CREATE INDEX IF NOT EXISTS forge_operations_status_idx
  ON app.forge_operations (status, created_at DESC, id DESC);
