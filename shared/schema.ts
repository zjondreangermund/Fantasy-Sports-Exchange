...
export const transactionTypeEnum = pgEnum("transaction_type", ["deposit", "withdrawal", "marketplace_buy", "marketplace_sale", "auction_bid_lock", "auction_bid_release", "auction_sale", "tournament_entry", "tournament_payout", "admin_adjustment", "bonus_credit", "purchase", "sale", "entry_fee", "prize", "swap_fee", "auction_bid", "auction_settlement"]);
