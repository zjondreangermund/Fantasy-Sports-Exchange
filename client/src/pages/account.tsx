...
import { Bell, User as UserIcon, Mail, CheckCircle2, Gift, Copy, Link2, Shield, Gavel, Users, Banknote } from "lucide-react";
    ...
    <div className="flex-1 overflow-auto p-4 sm:p-6 lg:p-8">
      <div className="max-w-5xl mx-auto">
        <div className="mb-6">
          ...
          <p className="text-sm text-muted-foreground">Profile, team settings and inbox notifications.</p>
        </div>
                  ...
                  <div className="rounded-lg border border-border/70 bg-muted/20 p-3">
                    ...
                    {adminCheck?.isAdmin ? (
                      ...
                      <p className="text-xs text-muted-foreground">
                        Admin-only tools appear automatically when this account has admin access.
                      </p>
                    )}
                  </div>
