    ...
    <div className="min-h-screen bg-background">
        ...
        <div className="relative z-10 mx-auto flex max-w-7xl items-center px-4 py-20 sm:px-6 sm:py-28 lg:px-8 lg:py-36">
          <div className="max-w-3xl">
            <motion.div initial={{ opacity: 0, y: 16 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.45, ease: "easeOut" }}>
              ...
              <p className="mt-6 max-w-xl text-lg text-white/70">Build your dream squad with collectible player cards. Trade rare cards, compete in leagues, and rise to the top of the leaderboards.</p>
              ...
              <div className="mt-5 flex flex-wrap gap-2">
                {["Live EPL-linked scoring", "Fast Google sign-in", "Clear rarity progression"].map((chip) => <span key={chip} className="inline-flex items-center gap-1 rounded-full border border-white/20 bg-white/10 px-3 py-1 text-xs text-white/80"><CheckCircle2 className="h-3.5 w-3.5" />{chip}</span>)}
              </div>
            </motion.div>
          </div>
        </div>
      ...
      <section className="relative z-20 mx-auto -mt-10 max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 gap-4 sm:grid-cols-3">
          <Card className="border-border/80 bg-card/95 p-5 backdrop-blur"><div className="mb-2 flex items-center gap-3"><div className="flex h-9 w-9 items-center justify-center rounded-md bg-primary/10"><BarChart3 className="h-5 w-5 text-primary" /></div><p className="text-sm text-muted-foreground">Live Data</p></div><p className="text-2xl font-bold text-foreground">EPL Sync</p><p className="mt-1 text-sm text-muted-foreground">Player points update from real match output</p></Card>
          <Card className="border-border/80 bg-card/95 p-5 backdrop-blur"><div className="mb-2 flex items-center gap-3"><div className="flex h-9 w-9 items-center justify-center rounded-md bg-primary/10"><Clock3 className="h-5 w-5 text-primary" /></div><p className="text-sm text-muted-foreground">Onboarding</p></div><p className="text-2xl font-bold text-foreground">~2 min</p><p className="mt-1 text-sm text-muted-foreground">Get cards, pick a lineup, enter your first contest</p></Card>
          <Card className="border-border/80 bg-card/95 p-5 backdrop-blur"><div className="mb-2 flex items-center gap-3"><div className="flex h-9 w-9 items-center justify-center rounded-md bg-primary/10"><TrendingUp className="h-5 w-5 text-primary" /></div><p className="text-sm text-muted-foreground">Progression</p></div><p className="text-2xl font-bold text-foreground">Level + Trade</p><p className="mt-1 text-sm text-muted-foreground">Build value through XP, market timing, and competition results</p></Card>
        </div>
      </section>
      ...
      <section className="mx-auto max-w-5xl px-4 pb-16 sm:px-6 lg:px-8"><Card className="border-primary/20 bg-gradient-to-br from-primary/10 via-background to-primary/5 p-8 text-center sm:p-10"><h3 className="mb-3 text-2xl font-bold text-foreground sm:text-3xl">Ready for Matchday?</h3><p className="mx-auto mb-6 max-w-xl text-muted-foreground">Join now, lock your lineup, and start climbing the leaderboard before the next kickoff.</p><a href={loginHref}><Button size="lg" data-testid="button-final-cta">Start Free with Google</Button></a></Card></section>
