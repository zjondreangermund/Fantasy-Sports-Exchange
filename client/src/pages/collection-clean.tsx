...
import { Archive, Crown, DollarSign, Gem, Search, ShieldCheck, Sparkles, Trophy, X } from "lucide-react";
...
export default function CollectionCleanPage() {
  ...
  const gridClass = "collection-card-grid grid grid-cols-2 justify-items-center gap-x-4 gap-y-8 pb-[calc(11rem+env(safe-area-inset-bottom,0px))] sm:grid-cols-3 lg:grid-cols-5 xl:grid-cols-6";
        ...
        <section className="rounded-[2rem] border border-white/10 bg-white/[0.065] p-4 shadow-[0_24px_80px_rgba(0,0,0,.45)] backdrop-blur-2xl sm:p-5">
          <div className="flex flex-col gap-4 lg:flex-row lg:items-end lg:justify-between">
            <div>
              ...
              <p className="mt-1 max-w-2xl text-sm text-slate-300">Tap cards for live detail. Sell cards with your own price before listing.</p>
            </div>
