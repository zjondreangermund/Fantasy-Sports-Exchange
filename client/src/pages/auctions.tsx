...
const RARITY_THEME: Record<RarityKey, {
  ...
  unique: {
    ...
    gradient: "from-purple-500/25 via-violet-500/8 to-transparent",
    glow: "shadow-[0_0_38px_rgba(168,85,247,.24)]",
    badge: "border-purple-300/45 bg-purple-500/20 text-purple-100",
    text: "text-purple-200",
    button: "bg-purple-500 text-white hover:bg-purple-400",
    soft: "border-purple-400/25 bg-purple-500/10",
  },
  epic: {
    border: "border-red-400/50",
    gradient: "from-red-500/28 via-rose-500/10 to-transparent",
    glow: "shadow-[0_0_40px_rgba(239,68,68,.26)]",
    badge: "border-red-300/50 bg-red-500/20 text-red-100",
    text: "text-red-200",
    button: "bg-red-500 text-white hover:bg-red-400",
    soft: "border-red-400/25 bg-red-500/10",
  },
  legendary: {
