  ...
  return (
    <LivePageShell tone="trading">
      ...
      <section className="grid gap-4 lg:grid-cols-[0.78fr_1.22fr]">
        ...
        <Card className="cinematic-glass isolate overflow-hidden border-white/10 bg-slate-950/60 p-5 text-white backdrop-blur-xl">
