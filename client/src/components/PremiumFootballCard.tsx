...
const themes: Record<string, Theme> = {
  common: {
    label: "COMMON",
    face: "linear-gradient(145deg,#b8c4d0 0%,#6e7e90 22%,#2a3444 50%,#586476 70%,#aab8c8 100%)",
    plate: "linear-gradient(145deg,#c0ccd8 0%,#7a8898 40%,#384858 72%,#a0b0c0 100%)",
    border: "#8090a8",
    glow: "rgba(148,163,184,.70)",
    glowSpread: "0 0 36px rgba(148,163,184,.70)",
    shadow: "rgba(100,120,140,.60)",
    text: "#e8f0f8",
    foil: "rgba(200,220,240,.55)",
  },
  rare: {
    label: "RARE",
    face: "linear-gradient(145deg,#7ab0e0 0%,#1e58b8 24%,#060f38 52%,#0c3888 72%,#5898d8 100%)",
    plate: "linear-gradient(145deg,#6898d0 0%,#1040a8 42%,#040c2c 72%,#4880c0 100%)",
    border: "#3068c0",
    glow: "rgba(59,130,246,.85)",
    glowSpread: "0 0 48px rgba(59,130,246,.85)",
    shadow: "rgba(30,80,200,.70)",
    text: "#deeeff",
    foil: "rgba(120,180,255,.62)",
  },
  unique: {
    label: "UNIQUE",
    face: "linear-gradient(145deg,#b868d8 0%,#6010b0 24%,#100228 52%,#4a0898 72%,#a058c8 100%)",
    plate: "linear-gradient(145deg,#a858c8 0%,#5008a0 42%,#0c0220 72%,#9048b8 100%)",
    border: "#8828c0",
    glow: "rgba(192,58,220,.88)",
    glowSpread: "0 0 48px rgba(192,58,220,.88)",
    shadow: "rgba(130,30,200,.72)",
    text: "#f0d8ff",
    foil: "rgba(210,140,255,.68)",
  },
  epic: {
    label: "EPIC",
    face: "linear-gradient(145deg,#7878d8 0%,#2020a0 24%,#040418 52%,#1818a0 72%,#6868d0 100%)",
    plate: "linear-gradient(145deg,#6868c8 0%,#1818a0 42%,#040416 72%,#5858c0 100%)",
    border: "#3838c8",
    glow: "rgba(99,102,241,.88)",
    glowSpread: "0 0 48px rgba(99,102,241,.88)",
    shadow: "rgba(60,50,210,.72)",
    text: "#e8e8ff",
    foil: "rgba(150,158,255,.65)",
  },
  legendary: {
    label: "LEGENDARY",
    face: "linear-gradient(145deg,#d8a820 0%,#906000 24%,#200e00 52%,#785000 72%,#c8a018 100%)",
    plate: "linear-gradient(145deg,#c89818 0%,#805400 38%,#180a00 68%,#b88810 100%)",
    border: "#c89820",
    glow: "rgba(220,148,10,.95)",
    glowSpread: "0 0 60px rgba(220,148,10,.95)",
    shadow: "rgba(180,100,0,.80)",
    text: "#fff0c0",
    foil: "rgba(255,210,80,.78)",
  },
};
    ...
    >
      <div
        style={{
          ...
          boxShadow: `0 0 0 1px rgba(255,255,255,.60) inset, 0 0 0 8px rgba(255,255,255,.06) inset, 0 0 10px rgba(255,255,255,.12), ${theme.glowSpread}, 0 28px 80px rgba(0,0,0,.72)`,
          fontFamily: "Inter, system-ui, sans-serif",
        }}
      >
        <div style={{ position: "absolute", inset: 6, zIndex: 6, borderRadius: 24, pointerEvents: "none", border: "1px solid rgba(255,255,255,.45)", boxShadow: `inset 0 0 14px rgba(255,255,255,.22), inset 0 0 30px rgba(255,255,255,.08), 0 0 18px ${theme.glow}` }} />
