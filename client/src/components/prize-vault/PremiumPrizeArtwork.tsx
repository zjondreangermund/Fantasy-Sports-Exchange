...
const palettes: Record<string, Palette> = {
  common: {
    accent: "#60a5fa",
    secondary: "#dbeafe",
    glow: "rgba(96,165,250,.58)",
    glowSoft: "rgba(96,165,250,.18)",
    surface: "#071525",
    surfaceDeep: "#020711",
    glassEdge: "rgba(219,234,254,.78)",
  },
  rare: {
    accent: "#168cff",
    secondary: "#dbeafe",
    glow: "rgba(22,140,255,.72)",
    glowSoft: "rgba(22,140,255,.22)",
    surface: "#031327",
    surfaceDeep: "#010611",
    glassEdge: "rgba(191,219,254,.92)",
  },
  unique: {
    accent: "#a855f7",
    secondary: "#f3e8ff",
    glow: "rgba(168,85,247,.72)",
    glowSoft: "rgba(168,85,247,.22)",
    surface: "#180622",
    surfaceDeep: "#08020d",
    glassEdge: "rgba(233,213,255,.90)",
  },
  epic: {
    accent: "#ef233c",
    secondary: "#fff1f2",
    glow: "rgba(239,35,60,.74)",
    glowSoft: "rgba(239,35,60,.22)",
    surface: "#250609",
    surfaceDeep: "#0d0103",
    glassEdge: "rgba(254,205,211,.92)",
  },
  legendary: {
    accent: "#f59e0b",
    secondary: "#fff7ed",
    glow: "rgba(245,158,11,.76)",
    glowSoft: "rgba(245,158,11,.22)",
    surface: "#241703",
    surfaceDeep: "#0c0701",
    glassEdge: "rgba(254,243,199,.92)",
  },
};
...
export function PremiumPrizeArtwork({ title, rarity, category }: Props) {
  ...
  return (
    <div
      ...
      style={{
        background: `
          radial-gradient(circle at 50% 26%, ${palette.glowSoft}, transparent 34%),
          radial-gradient(circle at 15% 18%, rgba(255,255,255,.08), transparent 18%),
          linear-gradient(145deg, ${palette.surface}, ${palette.surfaceDeep} 74%)
        `,
      }}
    >
      ...
      <div
        className="absolute inset-x-[7%] top-[7%] bottom-[8%] rounded-[1.7rem] border bg-white/[.025] backdrop-blur-[2px]"
        style={{
          borderColor: palette.glassEdge,
          boxShadow: `inset 0 1px 0 rgba(255,255,255,.32), inset 0 -1px 0 ${palette.glowSoft}, 0 0 26px ${palette.glowSoft}`,
        }}
      />
      ...
      <div
        className="absolute left-1/2 top-[57%] h-[22%] w-[70%] -translate-x-1/2 rounded-[50%] border border-white/10"
        style={{
          background: "radial-gradient(ellipse at 50% 35%,#334155 0%,#111827 30%,#030712 68%,#000 100%)",
          boxShadow: `inset 0 8px 18px rgba(255,255,255,.06), inset 0 -16px 24px rgba(0,0,0,.8), 0 7px 0 rgba(0,0,0,.72), 0 12px 28px rgba(0,0,0,.82), 0 0 22px ${palette.glowSoft}`,
        }}
      />
      ...
      <div className="absolute left-1/2 top-[38%] z-10 flex h-[42%] w-[47%] -translate-x-1/2 -translate-y-1/2 items-center justify-center rounded-[2rem] border border-white/15 bg-[linear-gradient(145deg,rgba(255,255,255,.10),rgba(255,255,255,.025))] shadow-[inset_0_1px_0_rgba(255,255,255,.18),0_26px_55px_rgba(0,0,0,.58)] backdrop-blur-md">
        ...
        <Icon
          ...
          style={{
            ...
            filter: `drop-shadow(0 0 12px ${palette.accent}) drop-shadow(0 16px 18px rgba(0,0,0,.72))`,
          }}
        />
      </div>
