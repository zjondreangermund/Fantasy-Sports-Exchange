...
type NavItem = {
  ...
  section: "Main" | "Account" | "Rules & Support";
  showUnread?: boolean;
};
        ...
        <Link href="/">
          ...
          >
            ...
            <div className="min-w-0">
              ...
              <p className="truncate text-[9px] font-semibold uppercase tracking-[0.22em] text-cyan-200/65">
                Play • Compete • Win
              </p>
            </div>
          </div>
        ...
        {sectionOrder.map((section) => {
          ...
          return (
            <SidebarGroup key={section}>
              <p className="px-3 pb-2 pt-3 text-[10px] font-black uppercase tracking-[0.22em] text-slate-600">
                {section}
              </p>
              <SidebarGroupContent>
                      ...
                      <SidebarMenuItem key={item.title}>
                        <SidebarMenuButton asChild isActive={active}>
                          ...
                          >
                            ...
                            {item.showUnread ? <UnreadNotificationDot /> : null}
                          </Link>
                        </SidebarMenuButton>
                      </SidebarMenuItem>
                    );
