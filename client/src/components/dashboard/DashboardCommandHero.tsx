...
import FreeTournamentCampaign from "./FreeTournamentCampaign";
      ...
      <div className="space-y-4">
        ...
        <div className="grid gap-4 lg:grid-cols-[1.2fr_0.8fr]">
          ...
          <div className="rounded-[1.5rem] border border-white/10 bg-gradient-to-br from-white/[0.08] to-white/[0.02] p-4">
            ...
            <p className="mt-2 text-sm text-slate-400">Enter the open FREE gameweek tournament first, then manage your cards and marketplace moves.</p>
            <div className="mt-4 flex flex-wrap gap-2">
              <Link href="/competitions"><Button size="sm">FREE Tournament <ArrowRight className="ml-2 h-4 w-4" /></Button></Link>
              <Link href="/collection"><Button size="sm" variant="outline">Lineup</Button></Link>
              <Link href="/marketplace"><Button size="sm" variant="outline">Marketplace</Button></Link>
            </div>
          </div>
        </div>
      </div>
