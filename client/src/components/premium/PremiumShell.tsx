...
export function PremiumPage({ children, className = "" }: { children: ReactNode; className?: string }) {
  return (
    <main className={`relative min-h-full overflow-hidden px-3 pb-32 pt-4 text-white sm:px-6 lg:px-8 ${className}`}>
      ...
      <div className="pointer-events-none absolute inset-0 opacity-[.12] fa-subtle-grid" />
