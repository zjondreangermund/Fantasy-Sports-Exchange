...
// 2) Admin backoffice endpoint: return live platform totals instead of the UI falling back to zero.
replaceOrThrow(
...
// 3) Play: active tournaments only in the main grid, completed tournaments in their own section.
replaceOrThrow(
...
// 4) Admin manager: add real delete action and split completed tournaments.
replaceOrThrow(
