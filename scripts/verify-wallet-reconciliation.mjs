...
const checks = [
  ...
  {
    name: "missing wallet repair excludes all hold history and is audited",
    file: "server/services/walletReconciliation.ts",
    patterns: [
      "repairSafeMissingWallets",
      "hold_ledger_history",
      "hold_history AS",
      "coalesce(h.hold_records, 0) = 0",
      "l.hold_ledger_history = 0",
      "l.nonposted_nonzero_transactions = 0",
      "l.posted_ledger_balance >= 0",
      "wallet.reconciliation.missing_wallet_repaired",
      "completed_ledger_without_hold_history",
