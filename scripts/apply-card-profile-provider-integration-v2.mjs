...
const fallbackBlock = `function lastScoresFallback(card: any) {
...
replaceOnce(cardsFile, fallbackBlock, `function lastScoresFallback(_card: any) {
  return [];
}`);
...
replaceOnce("client/src/lib/card-image.ts", "    imageUrl?: string | null;\n", "    imageUrl?: string | null;\n    verifiedImageUrl?: string | null;\n");
replaceOnce(
