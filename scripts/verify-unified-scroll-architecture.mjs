...
includesAll(main, ['import "./unified-scroll.css"', '"fantasy-site-v13"'], "Client entry point");
for (const legacy of [
...
expect(serviceWorker.includes('const CACHE_NAME = "fantasy-site-v13"'), "Service worker cache must invalidate stale card and Prize Vault bundles");
