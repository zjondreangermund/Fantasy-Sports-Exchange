...
const common = [
  ...
  makePrize("common-cap", "Fantasy Arena Team Cap", 600, "Merch", "common"),
  makePrize("common-football", "Premium Football", 700, "Football", "common"),
  makePrize("common-headset", "Gaming Headset", 850, "Gaming", "common"),
  makePrize("common-powerbank", "Fast-Charge Powerbank", 1000, "Electronics", "common"),
  makePrize("common-speaker", "Bluetooth Speaker", 1200, "Electronics", "common"),
  makePrize("common-jersey", "Official Club Jersey", 1400, "Merch", "common"),
  makePrize("common-controller", "PS5 Controller", 1700, "Gaming", "common"),
  makePrize("common-watch", "Smart Watch", 2000, "Electronics", "common"),
  makePrize("common-phone", "Entry Smartphone", 2500, "Electronics", "common"),
  makePrize("common-tablet", "Compact Tablet", 3000, "Electronics", "common"),
  makePrize("common-sports-voucher-5000", "N$5,000 Sports Store Voucher", 5000, "Voucher", "common"),
  makePrize("common-coffee-machine", "Premium Coffee Machine", 5200, "Home", "common"),
  makePrize("common-home-appliance-voucher-6000", "N$6,000 Home Appliance Voucher", 6000, "Voucher", "common"),
  makePrize("common-fitness-tracker", "Fitness Tracker", 6200, "Electronics", "common"),
  makePrize("common-portable-projector", "Portable Projector", 6400, "Electronics", "common"),
  makePrize("common-keyboard-mouse", "Gaming Keyboard and Mouse", 6500, "Gaming", "common"),
  makePrize("common-weekend-stay", "Weekend Stay Voucher", 6600, "Travel", "common"),
  makePrize("common-wireless-earbuds", "Wireless Earbuds", 6800, "Electronics", "common"),
  makePrize("common-cash-7000", "N$7,000 Cash", 7000, "Cash", "common"),
  makePrize("common-tv-32", "32-inch Smart TV", 7500, "Electronics", "common"),
  makePrize("common-travel-bag-set", "Travel Bag Set", 7800, "Travel", "common"),
  makePrize("common-fashion-voucher-8000", "N$8,000 Fashion Voucher", 8000, "Voucher", "common"),
  makePrize("common-laptop", "Laptop", 9000, "Computers", "common"),
  makePrize("common-home-furniture-voucher-10000", "N$10,000 Home Furniture Voucher", 10000, "Voucher", "common"),
  makePrize("common-soundbar", "Soundbar", 10500, "Electronics", "common"),
  makePrize("common-holiday-voucher", "Holiday Voucher", 11000, "Travel", "common"),
  makePrize("common-cash-12000", "N$12,000 Cash", 12000, "Cash", "common"),
  makePrize("common-gaming-console", "Gaming Console", 13000, "Gaming", "common"),
  makePrize("common-double-door-fridge", "Double-Door Fridge", 14000, "Home", "common"),
  makePrize("common-cash-15000", "N$15,000 Cash", 15000, "Cash", "common"),
  makePrize("common-bedroom-furniture-set", "Bedroom Furniture Set", 16000, "Home", "common"),
  makePrize("common-beach-holiday-voucher", "Beach Holiday Voucher", 17000, "Travel", "common"),
  makePrize("common-smartphone-pro", "Smartphone Pro", 17500, "Electronics", "common"),
  makePrize("common-luxury-watch", "Luxury Watch", 17800, "Accessory", "common"),
  makePrize("common-cash-18000", "N$18,000 Cash", 18000, "Cash", "common"),
  makePrize("common-home-entertainment-bundle", "Home Entertainment Bundle", 18500, "Electronics", "common"),
  makePrize("common-adventure-getaway-voucher", "Adventure Getaway Voucher", 19000, "Travel", "common"),
  makePrize("common-premium-laptop", "Premium Laptop", 19500, "Computers", "common"),
  makePrize("common-cash-20000", "N$20,000 Cash", 20000, "Cash", "common"),
  makePrize("common-living-room-furniture-set", "Living Room Furniture Set", 20500, "Home", "common"),
  makePrize("common-tv-55", "55-inch Smart TV", 21000, "Electronics", "common"),
  makePrize("common-tropical-holiday-package", "Tropical Holiday Package", 21500, "Travel", "common"),
  makePrize("common-tablet-pro", "Tablet Pro", 22000, "Electronics", "common"),
  makePrize("common-home-makeover-voucher", "Home Makeover Voucher", 22200, "Home", "common"),
  makePrize("common-cash-22500", "N$22,500 Cash", 22500, "Cash", "common"),
  makePrize("common-vehicle-deposit-voucher", "Vehicle Deposit Voucher", 24000, "Vehicle", "common"),
